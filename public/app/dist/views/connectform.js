...
class ConnectForm {
    ...
    generate() {
        ...
        let hostField = this.helper.input({ id: "connect_host", label: t("Host"), value: host, parent: hostWrapper });
        hostField.setAttribute("required", "required");
        // Port
        let portWrapper = this.helper.div({ class: "field", id: "field_port", parent: connectForm });
        let portField = this.helper.input({ id: "connect_port", label: t("Port"), value: port, parent: portWrapper });
        ...
        let usernameField = this.helper.input({ id: "username", label: t("Username"), value: username, parent: usernameWrapper });
