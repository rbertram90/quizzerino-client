...
import { GameEndMessage, RoundStartMessage } from "./messages.js";
...
export class GameWindow {
    ...
    public addEventListener(type: string, callback: EventListenerOrEventListenerObject) {
...
export class Game {
    ...
    protected components: any; // @todo sure this can be improved!?
    ...
    public static getInstance(gamewindow: GameWindow, serviceContainer: ServiceContainer): Game {
        if (Game.instance) {
    ...
    public service(service:("domhelper"|"formManager")) {
        ...
        switch (data.type) {
            ...
            case "round_start":
                if (data.previousquestion) {
                    game.showPreviousRoundSummary(data as RoundStartMessage);
                    setTimeout(() => {
            ...
            case "game_end":
                game.showGameEndedScreen(data as GameEndMessage);
                break;
        }
     ...
     * }
     */
    public showQuestionScreen(data: RoundStartMessage) {
        let helper = this.services.domhelper;
    ...
    public showPreviousRoundSummary(data: RoundStartMessage) {
        this.gamewindow.clear();
     ...
     * @param data Array of data passed from websocket response
     */
    public showGameEndedScreen(data: GameEndMessage) {
        this.gamewindow.clear();
        let helper = new DOMHelper;
