...
class ConnectForm {
    ...
    public getFieldValue(fieldName: ("host"|"port"|"username"|"rememberMe"|"icon")) {
    ...
    public generate(): HTMLFormElement {
        ...
        let hostField = <HTMLInputElement> this.helper.input({ id:"connect_host", label:t("Host"), value:host, parent:hostWrapper });
        hostField.setAttribute("required", "required");
    
        // Port
        let portWrapper = this.helper.div({ class:"field", id:"field_port", parent:connectForm });
        let portField = <HTMLInputElement> this.helper.input({ id:"connect_port", label:t("Port"), value:port, parent:portWrapper });
        ...
        let usernameField = <HTMLInputElement> this.helper.input({ id:"username", label:t("Username"), value:username, parent:usernameWrapper });
        ...
        let iconField = this.helper.input({ type:"hidden", name:"icon", value:default_icon, parent:iconWrapper, label:t("Player face") });
